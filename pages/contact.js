  ...
  const validateForm = () => {
    ...
    if (
      ...
      newErrors.contactEmail =
        "Contact email is required when you prefer to be contacted elsewhere"
    } else if (
      formData.canContactAtProvidedEmail === "no" &&
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        ></div>
        <div
          className='absolute bottom-20 right-1/3 w-64 h-64 bg-indigo-500/20 rounded-full blur-3xl animate-pulse'
                ...
                <form onSubmit={handleSubmit}>
                  <div className='mb-6'>
                    ...
                    <input
                      ...
                      className={`w-full bg-gray-700/50 text-white rounded-lg px-4 py-3 sm:py-4 text-base sm:text-lg focus:outline-none focus:ring-2 border ${
                        errors.name
                  ...
                  <div className='mb-6'>
                    <label className='block text-gray-300 mb-3 text-lg'>
                      Can we contact you at this email?
                    </label>
